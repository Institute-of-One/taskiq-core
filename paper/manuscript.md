...
**Keywords:** task-based image quality; model observer; MTF; NPS; NEQ; detectability; software validation; error injection; reproducible research

**Code and data:** `taskiq-core` (MIT). Code: <https://github.com/Institute-of-One/taskiq-core>. Archive DOI: [10.5281/zenodo.21422924](https://doi.org/10.5281/zenodo.21422924). Real-scanner data: LDCT-and-Projection-data, The Cancer Imaging Archive (CC BY 4.0), DOI [10.7937/9npb-2637](https://doi.org/10.7937/9npb-2637).
...
The theory is settled. The implementations are not, and this paper is about the gap between them.
...
Table 1 gives the outcome. No check fires at $\alpha = 0$ for any defect.
...
Run without modification on measured ACR phantom projections, the chain behaved as the theory requires across all seven reconstruction kernels (Table 2).
